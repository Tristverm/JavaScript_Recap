...
//Capturing is the process of handling an event starting from the outermost element, and then moving inward towards the target element. In capturing, the event starts at the highest level of the document tree and works its way down to the target element. This is useful for handling events that need to be intercepted or prevented from propagating further down the tree. The capturing phase is rarely used in practice, as it is more common to handle events during the bubbling phase.
